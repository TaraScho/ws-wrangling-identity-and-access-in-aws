...
For detailed setup and validation steps, see the [Prerequisites Lab](lab-0-prerequisites/lab-0-prerequisites.md).
...
- [Instructions](lab-1-layin-down-the-law/lab-1-instructions.md)
...
- [Instructions](lab-2-fencin-the-frontier/lab-2-instructions.md)
...
```bash
cd labs-two-hour-workshop/terraform
terraform destroy
```

See the [Prerequisites Lab](lab-0-prerequisites/lab-0-prerequisites.md) for full cleanup instructions including stopping Docker containers.
