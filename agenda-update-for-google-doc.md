...
| 11:15 – 11:30 | Lab 4: Permissions Boundaries & Condition Keys | [Instructions](https://github.com/TaraScho/ws-wrangling-identity-and-access-in-aws/blob/main/labs-full-day/lab-4-permissions-boundaries-and-condition-keys/README.md) | Tara |
...
1. GitHub URLs are updated to the new lab-numbered directory layout (e.g., `labs-full-day/lab-2-create-policy-version/README.md`), replacing the older `scenario-*.md` and `scenario-*/` paths.
