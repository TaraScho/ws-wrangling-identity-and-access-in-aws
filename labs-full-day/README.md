...
1. Confirm you have AWS CLI access to the workshop account.
1. Complete **Lab 1: Lab Setup** before any other lab.
1. Keep this page open — you'll return to it between blocks.

## After the Workshop

Once you're done for the day, run through the [Lab Cleanup Instructions](./lab-cleanup-instructions.md) to tear down any resources you deployed.
